    ...
    return (
        <div className=" w-[95%] mx-auto mt-2 rounded-xl shadow-md shadow-gray-500 pb-8">
            <div id="aboutUs_title" className="py-12 w-[80%] mx-auto text-center">
                ...
                <p className="text-black py-4 px-[5%] text-xl">Chúng mình cùng nhau xây dựng nền tảng này với mục tiêu biến việc thu thập tài liệu, quản lý điểm số môn học một cách đơn giản và hiệu quả hơn bao giờ hết.</p>
            </div>
            ...
            <div className="w-[90%] mx-auto shadow-md shadow-gray-500 rounded-xl  text-gray-700">
                <p className="p-8 ">Project-Quizzes được sinh ra để giải quyết một vấn đề thường gặp đó chính là
                    ...
                    <br/>
                    <br/>
                    Từ ý tưởng bân đầu đó , dự án của chúng mình tạo ra
                    với mục tiêu đó chính là xây dựng nên một cộng đồng cùng nhau thu thập tài liệu học tập
                    đối với các môn học ở CTU, có thể mở rộng ở tương lai xa nào đó. Nếu mà chỉ có thu thập
                    đề và làm bài thì có vẻ khá đơn giản và cũng có nhiều nên tảng khác đã có rồi vì thế
                    chúng mình muốn đem lại thêm các tính năng hỗ trợ việc học khác như là theo dỏi tiến trình học
                    tập, phân tích tiến độ giải đề của bạn để xem rằng liệu bạn có đang tiến bộ qua việc giải
                    đề hay không.
                ...
                <div className="px-8 py-4">
                    ...
                    <p>Xây dựng một cộng đồng chia sẻ tài liệu trắc nghiệm chất lượng cao.</p>
                </div>
