            ...
            <div className ="p-8 w-[600px] min-h-[400px] bg-[#f3f4f6] rounded-3xl flex flex-col">
                ...
                <div className="flex justify-end mt-[auto]">
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        className={`px-4 min-h-[3rem] ${isNegative?"bg-[#dd3f3f]":"bg-[#6366F1]"} text-white font-bold text-[1.3rem] rounded-xl flex justify-center items-center cursor-pointer`}>Xác nhận</div>
                        <div 
                        onClick={closeButton}
                        className="px-4 min-h-[3rem] bg-[#6366F1] text-white font-bold text-[1.3rem] rounded-xl flex justify-center items-center cursor-pointer">Hủy</div>
                    </div>
                </div>
